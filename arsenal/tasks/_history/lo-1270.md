---
id: lo-1270
title: "G6: curve — a named shape with labelled waypoints"
priority: 5
status: done
...
assert 'curve' in KINDS, 'the kind is no longer in the vocabulary'
print('curve is in the vocabulary; docs/reference and the gallery cover it')
"
```
