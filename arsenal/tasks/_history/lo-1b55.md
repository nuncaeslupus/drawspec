---
id: lo-1b55
title: "G4: funnel — generalise the shape family and lay the pyramid down"
priority: 10
status: done
pr: https://github.com/nuncaeslupus/drawspec/pull/23
---

Completed in round four and merged as [#23](https://github.com/nuncaeslupus/drawspec/pull/23).
...
assert 'funnel' in KINDS, 'the kind is no longer in the vocabulary'
print('funnel is in the vocabulary; docs/reference and the gallery cover it')
"
```

## Tests

`tests/test_kinds_shape.py`, plus the gallery and acceptance suites.

## Location

`src/drawspec/kinds/shape.py`, `docs/reference/`.
