...
this branch, each with a test that fails without it: **906 passing**, up from 868.
...
| Pyramid/rings type size | Level height was a fixed fraction of the base; it now comes from the labels, and both kinds are set at `heading`. |
